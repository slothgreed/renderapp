...
namespace KI.Asset
{
    ...
    public class Cube : IPolygon
    {
        ...
        private Polygon CreatePolygon(string name, Vector3 vertex0, Vector3 vertex1, Vector3 vertex2, Vector3 vertex3)
        {
            ...
            var front0 = new Vertex(vertex0, Vector2.Zero);
            var front1 = new Vertex(vertex1, Vector2.UnitY);
            var front2 = new Vertex(vertex2, Vector2.UnitX + Vector2.UnitY);
            var front3 = new Vertex(vertex3, Vector2.UnitX);
